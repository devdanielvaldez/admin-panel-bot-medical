...
const AppointmentDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchDetails = async () => {
      const response = await axios
        .get('https://api-jennifer-wkeor.ondigitalocean.app/apimedical3/api/' + 'appointments/' + searchParams.get('id'));
  ...
  const startAppointment = async () => {
    const response = await axios
      .get('https://api-jennifer-wkeor.ondigitalocean.app/apimedical3/api/' + 'turns/' + patientData._id)
      .then(async (d: any) => {
        // return console.log(d);
        await axios
          .get('https://api-jennifer-wkeor.ondigitalocean.app/apimedical3/api/' + 'turns/in_progress/' + d.data.data[0]._id)
          .then(() => {
  ...
  const finishAppointment = async () => {
    const response = await axios
      ...
      .then(async (d: any) => {
        // return console.log(d);
        await axios
          .get('https://api-jennifer-wkeor.ondigitalocean.app/apimedical3/api/' + 'turns/complete/' + d.data.data[0]._id)
          .then(async () => {
            ...
            await axios
            .get('https://api-jennifer-wkeor.ondigitalocean.app/apimedical3/api/' + 'accounting/' + patientData._id)
            .then((res) => {
              console.log(res);
            })
          })
