...
export default function CreateBranchOffice() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if(id) {
                axios
                .get('https://dra-daines-uduu3.ondigitalocean.app/api/branch-office/by-id/' + id)
                .then((res) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        axios
        .post('https://dra-daines-uduu3.ondigitalocean.app/api/branch-office/create-or-update', body, {
            headers: {
