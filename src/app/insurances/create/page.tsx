...
const InsuranceRegistration: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchCatalogs = async () => {
      try {
        const response = await axios.get("https://dra-daines-uduu3.ondigitalocean.app/api/insurances/get/catalogs");
        if (response.data.ok) {
  ...
  useEffect(() => {
    if (id) {
      const fetchInsurance = async () => {
        try {
          const response = await axios.get(`https://dra-daines-uduu3.ondigitalocean.app/api/insurances/${id}`);
          if (response.data.ok) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      if (id) {
        await axios.put(`https://dra-daines-uduu3.ondigitalocean.app/api/insurances/update/${id}`, {
          insuranceName,
          contactPhone,
        ...
        await axios.post("https://dra-daines-uduu3.ondigitalocean.app/api/insurances/create", {
          insuranceName,
          contactPhone,
          services: selectedServices,
          // userOfv,
