...
const ClinicalHistoryForm: React.FC<ClinicalHistoryFormProps> = ({
    ...
    const getAnalyzes = async (embedding: any) => {
        ...
        const response = await axios
            .post('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'clinical/history/analyze', {
                embedding: embedding
            });
    ...
    useEffect(() => {
        ...
        const fetchHistoryClinical = async () => {
            try {
                const response = await axios.get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'clinical/history/' + searchParams.get('id'));
        ...
        const fetchPatient = async () => {
            const response = await axios
                .get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'patient/find/' + searchParams.get('id'));
        ...
        const fetchDetails = async (id: string) => {
            ...
            const response = await axios
                .get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'appointments/' + id);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        e.preventDefault();
        try {
            await axios.post('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'clinical/history/create', {
                patientId,
                ...formData,
            });
