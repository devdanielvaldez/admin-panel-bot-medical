...
const TurnsList: React.FC = () => {
    ...
    const handleInProgress = async (id: string) => {
        const response = await axios.get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'turns/in_progress/' + id);
    ...
    const handleComplete = async (id: string) => {
        const response = await axios.get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'turns/complete/' + id);
