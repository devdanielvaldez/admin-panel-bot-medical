...
const TurnsList: React.FC = () => {
    ...
    const fetchAppointments = async () => {
        const response = await axios.get(process.env.API_URL + 'turns/all');
        console.log(response.data.data);
        setAppointments(response.data.data);
    };

    const handleConfirm = async (id: string) => {
        const response = await axios.get(process.env.API_URL + 'turns/confirm/' + id);
    ...
    const handleInProgress = async (id: string) => {
        const response = await axios.get(process.env.API_URL + 'turns/in_progress/' + id);
    ...
    const handleComplete = async (id: string) => {
        const response = await axios.get(process.env.API_URL + 'turns/complete/' + id);
