...
const ReportsPage = () => {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        const allResponse = await axios.get("https://api-jennifer-wkeor.ondigitalocean.app/api/accounting/reports/all");
        const insuranceResponse = await axios.get("https://api-jennifer-wkeor.ondigitalocean.app/api/accounting/reports/by-insurance");
        const serviceResponse = await axios.get("https://api-jennifer-wkeor.ondigitalocean.app/api/accounting/reports/by-service");
        const withInsuranceResponse = await axios.get("https://api-jennifer-wkeor.ondigitalocean.app/api/accounting/reports/with-insurance");
        const withoutInsuranceResponse = await axios.get("https://api-jennifer-wkeor.ondigitalocean.app/api/accounting/reports/without-insurance");
