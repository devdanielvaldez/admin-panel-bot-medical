...
const WorkDayForm = () => {
  ...
  useEffect(() => {
    const fetchWorkDayById = async () => {
      if (id) {
        try {
          const response = await axios.get(`https://dra-daines-uduu3.ondigitalocean.app/api/available-work-days/${id}`);
    ...
    try {
      ...
      if (id) {
        ...
        response = await axios.put(
          `https://dra-daines-uduu3.ondigitalocean.app/api/available-work-days/edit/${id}`,
          { dayOfWeek, workHours },
          { headers: { branchid } }
        );
      } else {
        ...
        response = await axios.post(
          "https://dra-daines-uduu3.ondigitalocean.app/api/available-work-days/create",
          { dayOfWeek, workHours },
          { headers: { branchid } }
        );
      }
