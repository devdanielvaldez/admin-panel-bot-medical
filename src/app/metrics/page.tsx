      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mt-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-8">
          <div className="p-4 bg-white rounded-lg shadow-lg text-center">
            ...
            <p className="text-2xl font-bold">{metrics?.maxAppointmentsMonth?.[0] || 'N/A'}</p>
            <p className="text-gray-500">{metrics?.maxAppointmentsMonth?.[1] || 'N/A'} citas</p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-lg text-center">
            <h2 className="text-lg font-semibold">🔝 Servicio más usado</h2>
            <p className="text-2xl font-bold">{metrics?.mostUsedServices[0]?.name || 'N/A'}</p>
            <p className="text-gray-500">{metrics?.mostUsedServices[0]?.count || 'N/A'} citas</p>
          </div>
        </div>
