...
const AppointmentMedicalDetails = forwardRef<{}, AppointmentMedicalDetailsProps>(({ appointmentId }, ref) => {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            const response = await axios
                .get('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'appointments/details/a/' + appointmentId);
    ...
    const handleSubmit = async () => {
        try {
            const response = await axios.post('https://dra-daines-uduu3.ondigitalocean.app/api/' + 'appointments/register/details', {
                appointmentId,
                physicalExamination,
